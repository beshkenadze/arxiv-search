...
test.describe('MiniLM 384d Quality Benchmark', () => {
  ...
  test('run full benchmark minilm', async ({ page }) => {
    await page.goto('/quality-bench-minilm.html')
    await expect(page.locator('h1')).toContainText('MiniLM')

    console.log('\n⚡ Running FULL benchmark with MiniLM 384d...\n')
    ...
    console.log('\n' + '='.repeat(70))
    console.log('  MINILM 384d FULL BENCHMARK RESULTS')
